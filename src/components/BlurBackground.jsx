...
const BlurBackground = () => {
    return (
        ...
        opacity-70'>
            ...
            <motion.div 
                className="bg-purple-00 w-[380px] h-[260px] rounded-full absolute"
                variants={circleVariants}
                animate="animate4"> 
            </motion.div>
            <motion.div 
                className="bg-emerald-800 w-[390px] h-[260px] rounded-full absolute"
                variants={circleVariants}
                animate="animate5"> 
            </motion.div>
            <motion.div 
                className="bg-green-800 w-[400px] h-[290px] rounded-full absolute"
                variants={circleVariants}
                animate="animate6"> 
            </motion.div>
        </div>
